...
const dispatch_override = if (@hasDecl(vk_options, "vk_dispatch")) vk_options.vk_dispatch else struct {};
...
const instance_functions = if (@hasDecl(dispatch_override, "instance"))
    ...
    vk.InstanceCommandFlags{
        ...
        .createDebugUtilsMessengerEXT = if (build_options.vk_enable_validation) true else false,
        .destroyDebugUtilsMessengerEXT = if (build_options.vk_enable_validation) true else false,
